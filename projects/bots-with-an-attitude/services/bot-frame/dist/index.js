...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    const machine = frame_1.default
        .withContext(Object.assign(Object.assign({}, frame_1.context), { controller: controller_1.default }))
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    botService.send("INSERT_CASSETTE", {
        cassette: Object.assign(Object.assign({}, test_1.default), { verb: "run" })
    });
    botService.send("INSERT_CASSETTE", {
        cassette: Object.assign(Object.assign({}, test_1.default), { verb: "play" })
    });
    botService.send("INSERT_CASSETTE", {
        cassette: Object.assign(Object.assign({}, test_1.default), { verb: "say" })
    });
});
main();
