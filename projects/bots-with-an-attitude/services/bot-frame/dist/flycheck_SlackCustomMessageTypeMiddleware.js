    ...
    onTurn(context, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (context.activity.type === 'message' && context.activity.channelData) {
                ...
                else if (context.activity.channelData.channel_type &&
                ...
                console.log(context.activity.channelData, context.activity.channelData.bot_id);
...
//# sourceMappingURL=flycheck_SlackCustomMessageTypeMiddleware.js.map