...
### 2. Embed the Public Badges Container into your webpage

In order to acquire the zero badge, you have to include the Public Badge
...
The Public Badges Container is a [webcomponent](https://www.webcomponents.org/introduction)
...
Upon submission of your request, we will check if your organization meets the
...
container. You can also download the [open badge artifact](./src-fixture) manually through
the link provided.